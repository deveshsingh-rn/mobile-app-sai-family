...
export enum SANGHA_ACTIONS {
  ...
  INVITE_GROUP_MEMBER_REQUEST = "sangha/INVITE_GROUP_MEMBER_REQUEST",
  INVITE_GROUP_MEMBER_SUCCESS = "sangha/INVITE_GROUP_MEMBER_SUCCESS",
  INVITE_GROUP_MEMBER_FAILURE = "sangha/INVITE_GROUP_MEMBER_FAILURE",
  APPROVE_GROUP_JOIN_REQUEST_REQUEST = "sangha/APPROVE_GROUP_JOIN_REQUEST_REQUEST",
  APPROVE_GROUP_JOIN_REQUEST_SUCCESS = "sangha/APPROVE_GROUP_JOIN_REQUEST_SUCCESS",
  APPROVE_GROUP_JOIN_REQUEST_FAILURE = "sangha/APPROVE_GROUP_JOIN_REQUEST_FAILURE",
  DECLINE_GROUP_JOIN_REQUEST_REQUEST = "sangha/DECLINE_GROUP_JOIN_REQUEST_REQUEST",
  DECLINE_GROUP_JOIN_REQUEST_SUCCESS = "sangha/DECLINE_GROUP_JOIN_REQUEST_SUCCESS",
  DECLINE_GROUP_JOIN_REQUEST_FAILURE = "sangha/DECLINE_GROUP_JOIN_REQUEST_FAILURE",
  ...
  UPDATE_GROUP_MEMBER_REQUEST = "sangha/UPDATE_GROUP_MEMBER_REQUEST",
  UPDATE_GROUP_MEMBER_SUCCESS = "sangha/UPDATE_GROUP_MEMBER_SUCCESS",
  UPDATE_GROUP_MEMBER_FAILURE = "sangha/UPDATE_GROUP_MEMBER_FAILURE",
  REMOVE_GROUP_MEMBER_REQUEST = "sangha/REMOVE_GROUP_MEMBER_REQUEST",
  REMOVE_GROUP_MEMBER_SUCCESS = "sangha/REMOVE_GROUP_MEMBER_SUCCESS",
  REMOVE_GROUP_MEMBER_FAILURE = "sangha/REMOVE_GROUP_MEMBER_FAILURE",
...
export type SanghaAction =
  ...
  | {
      ...
      type:
        ...
        | SANGHA_ACTIONS.INVITE_GROUP_MEMBER_SUCCESS
        | SANGHA_ACTIONS.INVITE_GROUP_MEMBER_FAILURE
        | SANGHA_ACTIONS.APPROVE_GROUP_JOIN_REQUEST_REQUEST
        | SANGHA_ACTIONS.APPROVE_GROUP_JOIN_REQUEST_SUCCESS
        | SANGHA_ACTIONS.APPROVE_GROUP_JOIN_REQUEST_FAILURE
        | SANGHA_ACTIONS.DECLINE_GROUP_JOIN_REQUEST_REQUEST
        | SANGHA_ACTIONS.DECLINE_GROUP_JOIN_REQUEST_SUCCESS
        | SANGHA_ACTIONS.DECLINE_GROUP_JOIN_REQUEST_FAILURE
        | SANGHA_ACTIONS.UPDATE_GROUP_MEMBER_REQUEST
        | SANGHA_ACTIONS.UPDATE_GROUP_MEMBER_SUCCESS
        | SANGHA_ACTIONS.UPDATE_GROUP_MEMBER_FAILURE
        | SANGHA_ACTIONS.REMOVE_GROUP_MEMBER_REQUEST
        | SANGHA_ACTIONS.REMOVE_GROUP_MEMBER_SUCCESS
        | SANGHA_ACTIONS.REMOVE_GROUP_MEMBER_FAILURE
